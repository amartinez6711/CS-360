...
import static com.example.myapplication.R.id.date_to_fire;

import com.example.myapplication.UpdateEvent;
...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.MyViewHolder>{
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int pos) {
        ...
        holder.itemView.findViewById(R.id.add_new_update).setOnClickListener((view -> {
